...
var require_creditcard = __commonJS({
  "node_modules/creditcard.js/dist/creditcard.js"(exports, module) {
    (function(g, f) {
      ...
      var getCreditCardNameByNumber = function getCreditCardNameByNumber2(number) {
        return findCreditCardObjectByNumber(number).name || "Credit card is invalid!";
      };
      var isSecurityCodeValid = function isSecurityCodeValid2(creditCardNumber, securityCode) {
      ...
      var isExpirationDateValid = function isExpirationDateValid2(month, year) {
        return isValidMonth(month) && isValidYear(year) && isFutureOrPresentDate(month, year);
      };
      var isValid = function isValid2(number) {
      ...
      function dateRange() {
        var increaseYear = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
      ...
      exports2.getCreditCardNameByNumber = getCreditCardNameByNumber;
      exports2.isExpirationDateValid = isExpirationDateValid;
      exports2.isSecurityCodeValid = isSecurityCodeValid;
 ...
 */
//# sourceMappingURL=creditcard__js.js.map
